...
conventions, and stack. If the request is ambiguous, clarify first (same loop as `architecture-planning`).
...
the design intent, not just that it renders. Then hand off to **quality-control** for the generic sweep
